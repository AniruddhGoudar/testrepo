...
import static Business.Roles.Roles.TypeOfRole.Admin;
import static Business.Roles.Roles.TypeOfRole.Executive;
import Business.UserAccountManagement.UserAccount;
import UI.Admin.AdminMainJPanel;
import UI.Customer.CustomerMainJPanel;
import UI.Executives.AssignCasesJPanel;
import UI.Executives.ExecutiveMainJPanel;
...
public class UserLogin extends javax.swing.JPanel {
    ...
    public UserLogin(JPanel workArea, Business business) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 30, 530, 520));

        jLabel1.setBackground(new java.awt.Color(102, 102, 255));
        jLabel1.setForeground(new java.awt.Color(153, 153, 255));
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, -10, 1930, 1100));
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_loginButtonActionPerformed
        ...
        userAccount = business.getUserAccDirectory().authenticateUser(userName, password);
        System.out.println("userAccount " + userAccount);
        System.out.println("userAccount " + business.getUserAccDirectory().getUserAccList().size());
        if (userAccount == null) {
            ...
            if (userAccount.getRole() == "Admin") {
                AdminMainJPanel adminPanel = new AdminMainJPanel(workArea, business);
                workArea.add(adminPanel);
                CardLayout layout = (CardLayout) workArea.getLayout();
                layout.next(workArea);
            } 
            else if (userAccount.getRole() == "Customer") {
                CustomerMainJPanel customerPanel = new CustomerMainJPanel(workArea, business,userAccount );
                workArea.add(customerPanel);
                CardLayout layout = (CardLayout) workArea.getLayout();
                layout.next(workArea); 
            }
            else if (userAccount.getRole() == "Executive") {
                ExecutiveMainJPanel executivePanel = new ExecutiveMainJPanel(workArea, business,userAccount );
                workArea.add(executivePanel);
                CardLayout layout = (CardLayout) workArea.getLayout();
                layout.next(workArea);
    ...
    private void signUpButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_signUpButtonActionPerformed
        // TODO add your handling code here:
        UserRegister register = new UserRegister(workArea, business);
